...
function Home_Popular_Desis_LIst() {
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (res.ok) {
                        ...
                        setDesies((prev) => prev.filter((item) => item._id !== id));
    ...
    return (
        <div>
            <div className='pt-10 '>
                <h1 className='text-4xl font-semibold text-center text-white py-14'>All Desis Data List</h1>
                        ...
                        <table className="table table-zebra">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th className='text-lg text-white '>Desis Name</th>
                            ...
                            <tbody>
                                {/* row 1 */}
                                {
                                    desies.map((data, index) => (
                                        <tr key={data._id}>

                                            <th className=' text-white text-[16px]'>{index + 1}</th>
                                            <th className=' text-white text-[16px]'>{data.Desis_Name}</th>
                                            ...
                                            >
                                                <Link href={`Home_Popular_Desis_List/${data._id}`}><FaEdit /></Link>
                                            </td>
...
export default Home_Popular_Desis_LIst

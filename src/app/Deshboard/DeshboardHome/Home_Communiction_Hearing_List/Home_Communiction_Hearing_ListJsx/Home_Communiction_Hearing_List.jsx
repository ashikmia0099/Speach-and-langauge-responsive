...
function Home_Communiction_Hearing_List() {
    ...
    console.log('teacher data', Questions)
    ...
    return (
        <div>
            <div className='pt-10 '>
                <h1 className='text-4xl font-semibold text-center text-white py-14'>Communication And Hearing Data List</h1>
                                ...
                                {/* row 1 */}
                                {
                                    Questions.map((data, index) => (
                                        <tr key={data._id}>
                                            ...
                                            >
                                                <Link href={`Home_Communiction_Hearing_List/${data._id}`}><FaEdit /></Link>
                                            </td>
...
export default Home_Communiction_Hearing_List

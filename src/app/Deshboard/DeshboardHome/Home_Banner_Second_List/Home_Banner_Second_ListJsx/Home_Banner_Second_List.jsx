...
function Home_Banner_Second_List() {
    ...
    console.log('teacher data', second_banner_image)
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (res.ok) {
                        ...
                        setSecBannerImage((prev) => prev.filter((item) => item._id !== id));
    ...
    return (
        <div>
            <div className='pt-10 '>
                <h1 className='text-4xl font-semibold text-center text-white py-14'> Swap Image Data List</h1>
                        ...
                        <table className="table table-zebra">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th className='text-lg text-white '>Teacher Name</th>
                            ...
                            <tbody>
                                {/* row 1 */}
                                {
                                    second_banner_image.map((data, index) => (
                                        <tr key={data._id}>
                                            ...
                                            <td className=' text-white text-[16px]'>
                                                ...
                                                <img src={data.Choose_Single_Type_Image || data.Choose_Dual_Type_Image_1} className='h-40 w-40 rounded-2xl' alt="Doctor Image" />
                                            ...
                                            >
                                                <Link href={`Home_Banner_Second_List/${data._id}`}><FaEdit /></Link>
                                            </td>

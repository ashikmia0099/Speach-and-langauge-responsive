...
function Home_Banner_List() {
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (res.ok) {
                        ...
                        setbanner_data((prev) => prev.filter((item) => item._id !== id));
    ...
    return (
        <div>
            <div className='pt-10 '>
                <h1 className='text-4xl font-semibold text-center text-white py-14'> Banner Data List</h1>
                                ...
                                {/* row 1 */}
                                {
                                    banner_data.map((data, index) => (
                                        <tr key={data._id}>
                                            ...
                                            >
                                                <Link href={`Home_Banner_List/${data._id}`}><FaEdit /></Link>
                                            </td>
...
export default Home_Banner_List

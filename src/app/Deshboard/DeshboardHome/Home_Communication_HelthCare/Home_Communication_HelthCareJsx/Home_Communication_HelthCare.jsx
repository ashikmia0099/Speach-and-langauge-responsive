...
function Home_Communication_HelthCare() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://speach-and-langauge-responsive.vercel.app/Communication_HelthCare_api", {
                method: 'POST',
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div className=' gap-3'>
                    <div>
                        ...
                        <input type="text" name='desisName' className="input w-full text-white text-lg" placeholder="Blog Title" required />
                    </div>
                </div>
                <div>
                    <legend className="text-lg font-semibold pt-5 text-white">Overview</legend>
                    <textarea className="textarea w-full text-white text-lg" name='Overview' placeholder="Description " rows={12} required></textarea>
                </div>
                <div>

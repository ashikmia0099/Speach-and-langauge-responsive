...
function About_Title_Text() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://speach-and-langauge-responsive.vercel.app/About_Title_Text_api", {
                method: 'POST',
        ...
        <div className='m-10 px-10 py-10 border border-[#9EFF00] rounded-2xl'>
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div>
                    ...
                    <input type="text" name='texttwo' className="input w-full text-white text-lg" placeholder="Title Text Two" required />
                </div>
                <div>

                    <legend className="fieldset-legend text-lg font-semibold pt-5">Description <span className=' text-[12px]'>(max 70 word)</span> </legend>
                    <textarea name='Descriptions' className="textarea w-full text-white" placeholder="Description" rows={12} ></textarea>

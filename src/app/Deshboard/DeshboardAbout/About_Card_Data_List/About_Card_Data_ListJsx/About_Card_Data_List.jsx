...
function About_Card_Data_List() {
  ...
  console.log("images", about_all_Image)
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (res.ok) {
                        ...
                        setabout_all_Image((prev) => prev.filter((item) => item._id !== id));
                    ...
                    <div className="overflow-x-auto">
                        <table className="table table-zebra">
                            ...
                            <tbody>
                                {/* row 1 */}
                                {
                                    about_all_Image.map((data, index) => (
                                        <tr key={data._id}>
                                            ...
                                            >
                                                <Link href={`About_Card_Data_List/${data._id}`}><FaEdit /></Link>
                                            </td>
